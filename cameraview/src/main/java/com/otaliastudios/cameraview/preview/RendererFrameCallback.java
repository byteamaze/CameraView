...
public interface RendererFrameCallback {
     ...
     * @param outputTextureId the final output texture id
     * @param scaleX the scaleX (in REF_VIEW) value
     * @param scaleY the scaleY (in REF_VIEW) value
     */
    @RendererThread
    void onRendererFrame(@NonNull SurfaceTexture surfaceTexture, int outputTextureId, float scaleX, float scaleY);
